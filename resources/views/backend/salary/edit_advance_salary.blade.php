            ...
            <div class="col-12">
                <div class="page-title-box">
                    <div class="page-title-right">
                        ...
                        <a href="{{ route('all.advance.salary') }}" class="btn btn-primary rounded-pill waves-effect waves-light">All Advance Salary </a>
                        </ol>
                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <select name="employee_id" class="form-control select2-hidden-accessible @error('employee_id') is-invalid @enderror" data-toggle="select2" data-width="100%" data-select2-id="1" tabindex="-1" aria-hidden="true">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <select name="month" class="form-control select2-hidden-accessible @error('month') is-invalid @enderror" data-toggle="select2" data-width="100%" data-select2-id="2" tabindex="-1" aria-hidden="true">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <select name="year" class="form-control select2-hidden-accessible @error('year') is-invalid @enderror" data-toggle="select2" data-width="100%" data-select2-id="3" tabindex="-1" aria-hidden="true">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="advance_salary" class="form-control @error('advance_salary') is-invalid @enderror" id="advance_salary" value="{{ $salary->advance_salary }}" >
