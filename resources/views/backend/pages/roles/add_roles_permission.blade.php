                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="tab-pane" id="settings">
                            <form id="myForm" method="post" action="{{ route('roles.permission.store') }}" >
                                @csrf
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group mb-3">
                                            ...
                                            <select name="role_id" class="form-control select2-hidden-accessible" data-toggle="select2" data-width="100%" data-select2-id="1" tabindex="-1" aria-hidden="true">
