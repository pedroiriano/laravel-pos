            ...
            <div class="col-12">
                <div class="page-title-box">
                    <div class="page-title-right">
                        ...
                        <a href="{{ route('all.customer') }}" class="btn btn-primary rounded-pill waves-effect waves-light">All Customer </a>
                        </ol>
                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="name" class="form-control @error('name') is-invalid @enderror" id="firstname" value="{{ $customer->name }}" >
                                            @error('name')
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="shopname" class="form-control @error('shopname') is-invalid @enderror" id="shopname" value="{{ $customer->shopname }}" >
                                            @error('shopname')
                                            <span class="text-danger"> {{ $message }} </span>
                                            @enderror
                                        </div>
