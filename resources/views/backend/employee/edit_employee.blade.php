            ...
            <div class="col-12">
                <div class="page-title-box">
                    <div class="page-title-right">
                        ...
                        <a href="{{ route('all.employee') }}" class="btn btn-primary rounded-pill waves-effect waves-light">All Employee </a>
                        </ol>
                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="name" class="form-control @error('name') is-invalid @enderror" id="firstname" value="{{ $employee->name }}" >
                                            @error('name')
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <select name="experience" class="form-select @error('experience') is-invalid @enderror" id="example-select">
                                                ...
                                                <option value="6 Year" {{ $employee->experience == '6 Year' ? 'selected' : '' }}>6 Year</option>
                                                <option value="7 Year" {{ $employee->experience == '7 Year' ? 'selected' : '' }}>7 Year</option>
                                                <option value="8 Year" {{ $employee->experience == '8 Year' ? 'selected' : '' }}>8 Year</option>
                                                <option value="9 Year" {{ $employee->experience == '9 Year' ? 'selected' : '' }}>9 Year</option>
                                                <option value="10 Year" {{ $employee->experience == '10 Year' ? 'selected' : '' }}>10 Year</option>
                                            </select>
                                            @error('experience')
                                            <span class="text-danger"> {{ $message }} </span>
                                            @enderror
