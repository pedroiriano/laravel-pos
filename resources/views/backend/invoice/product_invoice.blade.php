                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <div class="float-end">
                                    ...
                                    <p><b>Vat (11%):</b> <span class="float-end"> &nbsp;&nbsp;&nbsp; Rp. {{ Cart::tax() }}</span></p>
                                    <h3>Rp. {{ Cart::total() }}</h3>
                                </div>
                        ...
                        <div class="mt-4 mb-1">
                            <div class="text-end d-print-none">
                                ...
                                <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#category-modal">Create Invoice</button>
                            </div>
                        </div>
                    </div>
                </div> <!-- end card -->
            ...
            <div class="modal-body"> 
                ...
                <form id="myForm" class="px-3" method="post" action="{{ url('/final-invoice') }}">
                    ...
                    <div class="mb-3">
                        ...
                        <input class="form-control" type="text" id="pay" name="pay" placeholder="Pay Now" onInput="calcdue();">
                    </div>

                    <div class="mb-3">
                        <label for="username" class="form-label">Due Amount</label>
                        <input class="form-control" type="text" id="due" name="due" placeholder="Due Amount ">
                    </div>
                    ...
                    <input type="hidden" id="total2" name="total2" value="{{ Cart::total(null,null,'') }}">
