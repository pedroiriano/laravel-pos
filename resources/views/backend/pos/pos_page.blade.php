                    ...
                    <div class="card-body"> 
                            ...
                            <table class="table table-bordered border-primary mb-0">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ url('/cart-remove/'.$cart->rowId) }}"><i class="fas fa-trash-alt" style="color:#ffffff"></i></a>
                                        </td>
                                    </tr>
                                    @endforeach
                                </tbody>
                        ...
                        <form id="myForm" method="post" action="{{ url('/create-invoice') }}">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <select name="customer_id" class="form-control select2-hidden-accessible" data-toggle="select2" data-width="100%" data-select2-id="2" tabindex="-1" aria-hidden="true">
